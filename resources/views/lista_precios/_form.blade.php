...
@endif
    <div class="row">
        ...
        <div class="form-group col-12 col-sm-12 col-md-6 col-lg-4">
            ...
            @if ($edit)
                <select class="form-control" name="id_tipo_item" id="id_tipo_item" style="width: 100%" @if ($edit) required @else disabled @endif>
                    <option value="">Elegir tipo item</option>
        ...
        <div class="form-group col-12 col-sm-12 col-md-6 col-lg-4">
            ...
            <input type="text" class="form-control" @if ($edit) name="codigo" @endif id="codigo" value="{{ old('codigo', $lista_precio->codigo) }}" @if ($edit) required @else disabled @endif>
        </div>
        <div class="form-group col-12 col-sm-12 col-md-6 col-lg-4">
